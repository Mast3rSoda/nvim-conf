...
-- When to switch between rasterization methods
        ...
        matrix_pixel_threshold_vertical_bar = 0.7, -- 0: all pixels, 1: no pixel
        matrix_pixel_min_factor = 0.4, -- 0: all pixels, 1: no pixel
        volume_reduction_exponent = 0.2, -- 0: no reduction, 1: full reduction
        minimum_volume_factor = 0.3, -- 0: no limit, 1: no reduction
